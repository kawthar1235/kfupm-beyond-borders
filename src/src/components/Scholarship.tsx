...
import { ArrowRight, BookOpen, GraduationCap, HeartPulse, Home, Wallet } from 'lucide-react';
...
/** "What If Your Global Opportunity Was Fully Funded?" first, then the funding-led message. */
  ...
  return (
    <section id="scholarship" className="relative py-32" aria-labelledby="scholarship-title">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          {...fadeUp()}
          className="relative mt-24 overflow-hidden rounded-[2.5rem] bg-delft px-8 py-16 text-beige shadow-[0_30px_60px_rgba(29,42,98,0.25)] md:px-16 md:py-20"
        >

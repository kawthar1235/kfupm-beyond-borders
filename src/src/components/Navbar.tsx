      ...
      >
        <div className="flex items-center justify-between py-2 pl-5 pr-2">
          ...
          <div className="flex items-center gap-2">
            <a
              href="#apply"
              className="rounded-full bg-delft inline-block whitespace-nowrap px-4 py-2 text-sm font-bold text-beige shadow-[0_8px_20px_rgba(29,42,98,0.2)] transition hover:scale-105 hover:shadow-[0_10px_30px_rgba(29,42,98,0.3)] active:scale-95 sm:px-5 sm:py-2.5"
            >
              Apply Now
            </a>
            <button
